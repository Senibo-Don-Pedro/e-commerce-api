...
public class DataSeeder implements CommandLineRunner {
    ...
    private final SkuGenerator skuGenerator; // <-- 1. Inject your existing SkuGenerator
        ...
        if (productRepository.count() == 0) {
            ...
            for (int i = 0; i < 200; i++) {
                ...
                Product product = Product.builder()
                                         ...
                                         .category(category)
                                         // 2. Use the injected generator to create the SKU
    ...
    // 3. The local generateSku helper method has been removed.
}
